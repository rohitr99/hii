...
public class EmployeeServices {
	...
	static
	{
		emparr=new Employee[100];
	  	emparr[0] = new SalariedEmp(1,"harsh","1234567890","emp@email.com","Hr","MainHead",LocalDate.of(2007,7, 7),50,100);
	  	emparr[1] = new SalariedEmp(2,"shubham","2121122112","emp@email.com","Hr","MainHead",LocalDate.of(2007,7, 7),500,120);
	  	emparr[2] = new ContractedEmp(3,"om","12121212","emp@email.com","Hr","MainHead",LocalDate.of(2007,7, 7),50,200);
	  	emparr[3] = new ContractedEmp(4,"vivek","1241245656","emp@email.com","Hr","MainHead",LocalDate.of(2007,7, 7),50,300);
	...
	public static void addNewEmp(int ch)
	{
		...
		switch(ch)
		{
		  case 1:
			  ...
			  emparr[cnt]=new SalariedEmp(id,nm,mb,em,dept,desg,ldt,sal,bonus);
          ...
          case 2 :
              ...
              double charges = sc.nextDouble();
      	  	  emparr[cnt] = new ContractedEmp(id,nm,mb,em,dept,desg,ldt,hrs,charges);
      	  	  System.out.println("emp data is inserted..");
      	  	  cnt++;
      	      break;
	...
	{
		int pos=searchByID(pid);
		if(pos!=-1 && emparr[pos] instanceof SalariedEmp)
		{
	...
	public static boolean ModifySalByID(double sal, int id) {
			...
			if(pos!=-1)
			{
				...
				{
					((SalariedEmp)emparr[pos]).setSal(sal);
				}
				else if(emparr[pos] instanceof ContractedEmp)
				{
					((ContractedEmp)emparr[pos]).setCharges(sal);
				}
				else
				{
