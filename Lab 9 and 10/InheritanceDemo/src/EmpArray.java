	...
	public static void main(String[] args)
	{
		...
		do {
	        ...
	        case 2 : 
	        		...
	        		boolean status=EmployeeServices.ModifySalByID(sal,id);
	        		if(status)
	        		{
	        ...
	        case 4 : 
	        		...
	        		int id4=sc.nextInt();
	        		Employee e=EmployeeServices.searchByIDN(id4);
	        		if(e!=null)
	        		{
	        ...
	        case 6 : 
	        	...
	        	int id3=sc.nextInt();
	        	double bonus=EmployeeServices.calculateBonusByID(id3);
	        	if(bonus!=-1)
	        	{
